...
"[project]/app/lib/authApi.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function fetchExistemUtilizadores() {
    const res = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiPath"])("api/auth/existem-utilizadores"));
...
async function postLogin(email, password) {
    return fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiPath"])("api/auth/login"), {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function postRegistarPrimeiroUtilizador(body) {
    return fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiPath"])("api/auth/registar-primeiro-utilizador"), {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function postForgotPassword(email) {
    return fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiPath"])("api/auth/forgot-password"), {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function postResetPassword(body) {
    return fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiConfig$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiPath"])("api/auth/reset-password"), {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
/** Agenda a renovação do JWT 5 minutos antes de expirar. */ function useRefreshTokenScheduler() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getToken"])()) return;
        scheduleRefresh();
        return ()=>{
...
function UserProvider({ children }) {
    ...
    const { data, isLoading, refetch: queryRefetch, isFetching } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            ...
            const raw = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$authApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAuthMe"])(token);
            if (!raw) return null;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bdca48a4._.js.map