...
"[project]/app/funcionarios/[id]/eliminar/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EliminarFuncionarioPage() {
    ...
    const { data: funcionario, isLoading: loadingApi, error: queryError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "funcionarios",
            id,
            "delete"
        ...
        queryFn: async ()=>{
            ...
            const item = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$funcionariosApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchDeleteGet"])(token, numId);
            const raw = item;
    ...
    const mutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: async ()=>{
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getToken"])();
            if (!token) throw new Error("Sessão expirada.");
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$funcionariosApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteFuncionarioApi"])(token, numId);
        },
        onSuccess: ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$stores$2f$useToastStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToastStore"].getState().show("Funcionário eliminado.", "success");
...
//# sourceMappingURL=app_0582481e._.js.map