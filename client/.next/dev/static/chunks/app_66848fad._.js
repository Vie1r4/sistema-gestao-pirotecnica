...
const API_CORRELATION_ID_HEADER = "X-Correlation-Id";
...
"[project]/app/lib/authApi.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "postLogin",
    ()=>postLogin,
    "postRegistarPrimeiroUtilizador",
    ()=>postRegistarPrimeiroUtilizador,
    "postResetPassword",
    ()=>postResetPassword
]);
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/apiConfig.ts [app-client] (ecmascript)");
;
async function fetchExistemUtilizadores() {
    const res = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPath"])("api/auth/existem-utilizadores"));
...
async function postLogin(email, password) {
    return fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPath"])("api/auth/login"), {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function postRegistarPrimeiroUtilizador(body) {
    return fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPath"])("api/auth/registar-primeiro-utilizador"), {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function postForgotPassword(email) {
    return fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPath"])("api/auth/forgot-password"), {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function postResetPassword(body) {
    return fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$apiConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPath"])("api/auth/reset-password"), {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
/** Agenda a renovação do JWT 5 minutos antes de expirar. */ function useRefreshTokenScheduler() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useRefreshTokenScheduler.useEffect": ()=>{
            ...
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getToken"])()) return;
            scheduleRefresh();
            return ({
                "useRefreshTokenScheduler.useEffect": ()=>{
    ...
    const { data, isLoading, refetch: queryRefetch, isFetching } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "UserProvider.useQuery": async ()=>{
                ...
                const raw = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$authApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAuthMe"])(token);
                if (!raw) return null;
...
_s1(UserProvider, "m85ix7PtgC+NEwoAGrHyeOGufZ8=", false, function() {
    return [
        useRefreshTokenScheduler,
...
//# sourceMappingURL=app_66848fad._.js.map