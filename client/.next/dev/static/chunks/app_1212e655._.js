...
"[project]/app/lib/documentacaoPdf.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/documentacao/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$documentacaoPdf$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/documentacaoPdf.ts [app-client] (ecmascript)");
...
function DocumentacaoPage() {
    ...
    const { data, isLoading, error, isRefetching } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "documentacao",
            "servicos-picker"
        ],
        queryFn: {
            "DocumentacaoPage.useQuery": async ()=>{
                ...
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$servicos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["fetchServicosFromApi"])(t, undefined, 1, 200);
                return res.lista ?? [];
            }
        }["DocumentacaoPage.useQuery"],
    ...
    const handleGerarDeclaracaoTeste = ()=>{
        ...
        setGerandoPdf(true);
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$documentacaoPdf$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gerarDeclaracaoTestePdf"])(dadosPdfBase);
        } finally{
            setGerandoPdf(false);
        }
    };
    const handleGerarLicencaTeste = ()=>{
        ...
        setGerandoPdf(true);
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$documentacaoPdf$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gerarLicencaTestePdf"])(dadosPdfBase);
        } finally{
            setGerandoPdf(false);
        }
    };
    const handleGerarAutorizacaoTeste = ()=>{
        ...
        setGerandoPdf(true);
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$documentacaoPdf$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gerarAutorizacaoTestePdf"])(dadosPdfBase);
        } finally{
            setGerandoPdf(false);
        }
    };
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        servicos.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: s.id,
                                                children: [
                                                    "#",
                                                    s.id,
...
_s(DocumentacaoPage, "QIy0cRkSZSz1z0Q0wnz5fjw13WU=", false, function() {
    return [
...
_c = DocumentacaoPage;
var _c;
__turbopack_context__.k.register(_c, "DocumentacaoPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=app_1212e655._.js.map