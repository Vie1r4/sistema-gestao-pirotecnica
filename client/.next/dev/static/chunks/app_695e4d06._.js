...
"[project]/app/lib/armazem.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/**
 * Tipos e constantes para a área Armazém (Paióis).
 * Dados vêm apenas da API (paiolApi). Sem localStorage.
 */ /** Perfil de risco (classificação licença): 1.1 a 1.6 — exibido como 1.1G, 1.2G, etc. */ __turbopack_context__.s([
    "CARGOS_ACESSO_PAIOL",
    ()=>CARGOS_ACESSO_PAIOL,
    "ESTADOS_PAIOL",
    ()=>ESTADOS_PAIOL,
...
const CARGOS_ACESSO_PAIOL = [
    "Admin",
    "Armazém",
    "Gestor",
    "Comercial"
];
function labelPerfilRisco(value) {
    return value === "1.4S" ? value : `${value}G`;
}
function validarLimiteMLE(val) {
...
"[project]/app/armazem/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$context$2f$UserContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/context/UserContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$armazem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/armazem.ts [app-client] (ecmascript)");
...
;
;
function mapApiToPaiolDetalhe(data, id) {
    if (!data) return null;
    const p = data.paiol ?? data.Paiol;
    if (!p) return null;
    const get = (key)=>p[key] ?? p[key.charAt(0).toUpperCase() + key.slice(1)];
    const docExtras = get("documentosExtras") ?? get("DocumentosExtras") ?? [];
    const cargos = get("cargosAcesso") ?? data.cargosAcesso ?? data.CargosAcesso ?? [];
    const paiol = {
        id: String(get("id") ?? get("Id") ?? id),
        nome: String(get("nome") ?? get("Nome") ?? ""),
        localizacao: get("localizacao") ?? get("Localizacao"),
        coordenadasLat: get("coordenadasLat") ?? get("CoordenadasLat"),
        coordenadasLng: get("coordenadasLng") ?? get("CoordenadasLng"),
        ...
        dataValidadeLicenca: get("dataValidadeLicenca") ?? get("DataValidadeLicenca"),
        numeroLicenca: get("numeroLicenca") ?? get("NumeroLicenca"),
        divisaoDominante: get("divisaoDominante") ?? get("DivisaoDominante"),
        cargosAcesso: Array.isArray(cargos) ? cargos : [],
        documentosExtras: docExtras.map((d)=>({
                id: String(d.id ?? d.Id ?? ""),
                nome: String(d.nome ?? d.Nome ?? ""),
                caminho: d.caminho ?? d.Caminho
            })),
        dataRegisto: get("dataRegisto") ?? get("DataRegisto") ?? new Date().toISOString()
    };
    const cargaRaw = data.carga ?? data.Carga;
    const carga = Array.isArray(cargaRaw) ? cargaRaw.map((x)=>({
...
function PaiolDetalhePage() {
    ...
    const { data: detalheData, isLoading: loadingApi, isRefetching, error: queryError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "armazem",
            "paiol",
            id
        ...
        queryFn: {
            "PaiolDetalhePage.useQuery": async ()=>{
                ...
                try {
                    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$paiolApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchPaiolDetalheJson"])(token, numId);
                    if (!data) return null;
        ...
        }["PaiolDetalhePage.useQuery"],
        staleTime: 30 * 1000,
        retry: 2,
        enabled: validId && !!(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getToken"])()
    });
    ...
    if (loadingApi) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/app/armazem/[id]/page.tsx",
                lineNumber: 134,
                columnNumber: 9
            }, this)
        }, void 0, false, {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                    ...
                    children: [
                        queryError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: errorApi ?? "Erro ao carregar detalhes."
                        }, void 0, false, {
                            fileName: "[project]/app/armazem/[id]/page.tsx",
                            lineNumber: 145,
                            columnNumber: 13
                        ...
                        !queryError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: errorApi ?? "Paiol não encontrado."
                        }, void 0, false, {
                            fileName: "[project]/app/armazem/[id]/page.tsx",
                            lineNumber: 149,
                            columnNumber: 27
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        (criado || editado) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].p, {
                            ...
                            children: criado ? "Paiol criado com sucesso." : "Alterações guardadas."
                        }, void 0, false, {
                            fileName: "[project]/app/armazem/[id]/page.tsx",
                            lineNumber: 170,
                            columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            href: `/armazem/${id}/conteudo`,
                                            className: btnPrimary,
                                            children: "Ver conteúdo do paiol"
                                        }, void 0, false, {
                                            fileName: "[project]/app/armazem/[id]/page.tsx",
                                            lineNumber: 202,
                                            columnNumber: 15
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("dd", {
                                                            className: "mt-1 text-gray-600 dark:text-gray-400",
                                                            children: paiol.cargosAcesso?.length ? paiol.cargosAcesso.join(", ") : "—"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/armazem/[id]/page.tsx",
                                                            lineNumber: 241,
                                                            columnNumber: 19
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("dd", {
                                                            className: "mt-1 text-gray-600 dark:text-gray-400",
                                                            children: paiol.dataValidadeLicenca ? new Date(paiol.dataValidadeLicenca).toLocaleDateString("pt-PT") : "—"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/armazem/[id]/page.tsx",
                                                            lineNumber: 262,
                                                            columnNumber: 19
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("dd", {
                                                            className: "mt-1 text-gray-600 dark:text-gray-400",
                                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$armazem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["labelPerfilRisco"])(paiol.perfilRisco)
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/armazem/[id]/page.tsx",
                                                            lineNumber: 268,
                                                            columnNumber: 19
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].section, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Coordenadas do paiol. Ao integrar a API do mapa, poderá seleccionar o ponto no mapa para preencher automaticamente."
                                }, void 0, false, {
                                    fileName: "[project]/app/armazem/[id]/page.tsx",
                                    lineNumber: 291,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].section, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "mt-1 text-sm text-gray-600 dark:text-gray-400",
                                    children: "Produtos em stock (quantidade × NEM por unidade = NEM total). Ocupação baseada em NEM (legislação portuguesa)."
                                }, void 0, false, {
                                    fileName: "[project]/app/armazem/[id]/page.tsx",
                                    lineNumber: 311,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: carga.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-gray-500 dark:text-gray-400",
                                        children: 'Nenhum produto em stock. Use "Adicionar material" no conteúdo do paiol para registar entradas.'
                                    }, void 0, false, {
                                        fileName: "[project]/app/armazem/[id]/page.tsx",
                                        lineNumber: 316,
                                        columnNumber: 17
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                            className: "pb-2 font-semibold text-gray-700 dark:text-gray-300",
                                                            children: "Produto"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/armazem/[id]/page.tsx",
                                                            lineNumber: 323,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    onClick: ()=>{
                                                        ...
                                                        if (token && !Number.isNaN(numId) && !Number.isNaN(extraId)) {
                                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$paiolApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openDocumento"])(token, numId, extraId).catch(()=>alert("Não foi possível abrir o documento."));
                                                        } else {
...
_s(PaiolDetalhePage, "5pzKdtrTnwu5ERall+QlBZA1VHY=", false, function() {
    return [
...
_c = PaiolDetalhePage;
var _c;
__turbopack_context__.k.register(_c, "PaiolDetalhePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=app_695e4d06._.js.map