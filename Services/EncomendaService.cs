...
// Prepara a encomenda: gera saídas de stock por FIFO (data fabrico/entrada) e passa estado a Em preparação
public class EncomendaService : IEncomendaService
{
    ...
    // Valida retiradas, cria saídas por FIFO e marca encomenda como Em preparação
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Validar que todos os itens e paióis são válidos
        ...
        // Quantidade retirada por item tem de bater com a quantidade pedida
        ...
        // Calcular quanto resta em cada entrada (para FIFO)
        ...
        // Criar saídas por FIFO (primeiro DataFabrico, depois DataEntrada)
        foreach (var r in retiradasComQuantidade)
        {
