...
// Serviço no terreno (evento pirotécnico). Está sempre ligado a uma encomenda concluída — o material vem dessa encomenda.
public class Servico
{
    public int Id { get; set; }

    // Encomenda cujo material é usado neste serviço; relação 1:1 (uma encomenda = um serviço)
    ...
    // Copiado da encomenda para filtrar listagens sem carregar a encomenda
    ...
    // Raio em metros para o mapa (círculo de segurança ao público)
    ...
    // Distâncias mínimas a habitações, estradas, etc. (preenchidas no local)
